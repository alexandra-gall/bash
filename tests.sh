#!/bin/bash
#TASK: Write autotests for any 20 Linux commands.
#There must be at least 10 unique commands, at least 5 load autotests.
#Check that the program has done what it should (output to both threads, return code).
